  ...
  const TRANSLATIONS = {
    es: {
      ...
      messages: {
        ...
        shareUrlCopy: "Copia esta URL:",
        shareUrlError: "No se pudo generar la URL para compartir.",
        shareUrlLoaded: "Configuracion cargada desde URL compartida.",
        shareUrlSuccess: "URL copiada al portapapeles.",
      ...
      ui: {
        ...
        config: {
          ...
          emoji: {
            both: "↔️ En ambos lados",
            prefix: "⬅️ Solo al inicio",
            suffix: "➡️ Solo al final",
            none: "🚫 Sin emoji",
          },
        },
        participants: {
    ...
    en: {
      ...
      messages: {
        ...
        shareUrlCopy: "Copy this URL:",
        shareUrlError: "Could not generate share URL.",
        shareUrlLoaded: "Settings loaded from shared URL.",
        shareUrlSuccess: "URL copied to clipboard.",
      ...
      ui: {
        ...
        config: {
          ...
          emoji: {
            both: "↔️ On both sides",
            prefix: "⬅️ Only at start",
            suffix: "➡️ Only at end",
            none: "🚫 No emoji",
          },
        },
        participants: {
    ...
    "pt-BR": {
      ...
      messages: {
        ...
        shareUrlCopy: "Copie esta URL:",
        shareUrlError: "Nao foi possivel gerar a URL de compartilhamento.",
        shareUrlLoaded: "Configuracao carregada da URL compartilhada.",
        shareUrlSuccess: "URL copiada para a area de transferencia.",
      ...
      ui: {
        ...
        config: {
          ...
          emoji: {
            both: "↔️ Nos dois lados",
            prefix: "⬅️ Somente no inicio",
            suffix: "➡️ Somente no final",
            none: "🚫 Sem emoji",
          },
        },
        participants: {
